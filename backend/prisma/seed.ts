...
const demoProducts = [
  {
    ...
    fullDescription:
      'Флагман для тех, кто хочет максимум: мощный чип A17 Pro, аккумулятор на весь день, поддержка eSIM и физической SIM.',
  ...
  },
  {
    ...
    fullDescription:
      'Отличный выбор для ежедневных задач: мощный процессор, поддержка 5G и выдающаяся автономность.',
  ...
  },
  {
    ...
    fullDescription:
      'Снимайте в ProRAW, записывайте видео в 4K и не переживайте за место: 512 ГБ памяти хватит для всего.',
  ...
  },
  {
    ...
    fullDescription:
      'Идеально сбалансированный iPhone: яркий экран, быстрый A15 Bionic и поддержка съемки в кинематографическом режиме.',
  ...
  },
  {
    ...
    fullDescription:
      'Любимый форм‑фактор с кнопкой Touch ID, быстрый процессор и поддержка беспроводной зарядки.',
  ...
  },
  {
    ...
    fullDescription:
      'Наушники, которые всегда с вами: пространственное аудио, 6 часов работы от батареи и чехол с динамиком.',
  ...
  },
  {
    ...
    fullDescription:
      'Отслеживайте спорт, сон и здоровье с новыми датчиками и мощным процессором S9.',
  ...
  },
  {
    ...
    fullDescription:
      'Высокая мощность всасывания, умный дисплей и набор насадок для любых задач уборки.',
  ...
  },
  {
    ...
    fullDescription:
      'Игры нового поколения с трассировкой лучей, 4K HDR и быстрыми загрузками благодаря SSD.',
